/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be86190bca66e3d563fcc11e7be382ad)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		RATE_LIMIT_LOGIN_IP_MAX_ATTEMPTS: string;
		RATE_LIMIT_LOGIN_USER_MAX_ATTEMPTS: string;
		RATE_LIMIT_LOGIN_WINDOW_MINUTES: string;
		LOG_LEVEL: string;
		CORS_ALLOWED_ORIGINS_DEV: string;
		CORS_ALLOW_CREDENTIALS_DEV: string;
		CORS_MAX_AGE_DEV: string;
		CORS_ALLOWED_ORIGINS_PROD: string;
		CORS_ALLOW_NO_ORIGIN_PROD: string;
		CORS_ALLOW_CREDENTIALS_PROD: string;
		CORS_ALLOWED_METHODS_PROD: string;
		CORS_ALLOWED_HEADERS_PROD: string;
		CORS_EXPOSED_HEADERS_PROD: string;
		CORS_MAX_AGE_PROD: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_PRETTY" | "BUN_ENV" | "PORT" | "API_SECRET" | "SERVER_HOST" | "JWT_ACCESS_SECRET" | "JWT_REFRESH_SECRET" | "JWT_ACCESS_EXPIRY" | "JWT_REFRESH_EXPIRY" | "RATE_LIMIT_LOGIN_IP_MAX_ATTEMPTS" | "RATE_LIMIT_LOGIN_USER_MAX_ATTEMPTS" | "RATE_LIMIT_LOGIN_WINDOW_MINUTES" | "LOG_LEVEL" | "CORS_ALLOWED_ORIGINS_DEV" | "CORS_ALLOW_CREDENTIALS_DEV" | "CORS_MAX_AGE_DEV" | "CORS_ALLOWED_ORIGINS_PROD" | "CORS_ALLOW_NO_ORIGIN_PROD" | "CORS_ALLOW_CREDENTIALS_PROD" | "CORS_ALLOWED_METHODS_PROD" | "CORS_ALLOWED_HEADERS_PROD" | "CORS_EXPOSED_HEADERS_PROD" | "CORS_MAX_AGE_PROD">> {}
}
